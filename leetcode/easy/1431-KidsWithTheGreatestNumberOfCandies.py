...
class Solution:
    def kidsWithCandies(self, candies: List[int], extraCandies: int) -> List[bool]:
        max_candies, hasMoreThanRest = max(candies), []
        for candie in candies:
            candie_amount = extraCandies + candie
            hasMoreThanRest.append(True if candie_amount >= max_candies else False)

        return hasMoreThanRest