...
class FiftyThirtyTwentyStrategy(unittest.TestCase):
    def test_fifty_thirty_twenty(self):
        self.assertEqual(fifty_thirty_twenty(10000), {
                         "Needs": 5000, "Wants": 3000, "Savings": 2000})
        self.assertEqual(fifty_thirty_twenty(50000), {
                         "Needs": 25000, "Wants": 15000, "Savings": 10000})
        self.assertEqual(fifty_thirty_twenty(13450), {
                         "Needs": 6725, "Wants": 4035, "Savings": 2690})
        self.assertEqual(fifty_thirty_twenty(27800), {
                         "Needs": 13900, "Wants": 8340, "Savings": 5560})
        self.assertEqual(fifty_thirty_twenty(19000), {
                         "Needs": 9500, "Wants": 5700, "Savings": 3800})
        self.assertEqual(fifty_thirty_twenty(17610), {
                         "Needs": 8805, "Wants": 5283, "Savings": 3522})
        self.assertEqual(fifty_thirty_twenty(25000), {
                         "Needs": 12500, "Wants": 7500, "Savings": 5000})
        self.assertEqual(fifty_thirty_twenty(100000), {
                         "Needs": 50000, "Wants": 30000, "Savings": 20000})
        self.assertEqual(fifty_thirty_twenty(347100), {
                         "Needs": 173550, "Wants": 104130, "Savings": 69420})
