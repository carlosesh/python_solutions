...
class GetTheAreaOfACountry(unittest.TestCase):
    def test_area_of_country(self):
        self.assertEqual(area_of_country("USA", 9372610),
                         "USA is 6.29% of the total world's landmass")
        self.assertEqual(area_of_country("Russia", 17098242),
                         "Russia is 11.48% of the total world's landmass")
        self.assertEqual(area_of_country("Iran", 1648195),
                         "Iran is 1.11% of the total world's landmass")
        self.assertEqual(area_of_country("India", 3287590),
                         "India is 2.21% of the total world's landmass")
        self.assertEqual(area_of_country("China", 9706961),
                         "China is 6.52% of the total world's landmass")
        self.assertEqual(area_of_country("Yemen", 527968),
                         "Yemen is 0.35% of the total world's landmass")
        self.assertEqual(area_of_country("Switzerland", 41284),
